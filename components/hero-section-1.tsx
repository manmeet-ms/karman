    ...
    return (
        <>
            ...
            <main className="overflow-hidden">
                <div
                    aria-hidden
                    className="  absolute inset-0 -z-30 h-screen    contain-strict hidden lg:block">
                        <Silk
    speed={5}
    scale={0.9}
    color="#292e29"
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants as any}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">For those who can't change</span>
                                    ...
                                    <h1
                                        className="mt-8 mt:4 max-w-4xl mx-auto text-balance text-6xl md:text-7xl lg:mt-16 xl:text-[5.25rem]">
                                        We are not here to motivate you. We are here to govern you.
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                        Discipline is submission to rules you set when rational. Enforced when you are weak. This app is your externalized prefrontal cortex.
                                    </p>
                                </AnimatedGroup>
                                ...
                                {/* <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button size="lg" className="rounded-xl px-5 text-base" render={<Link href="#link" />} nativeButton={false}><span className="text-nowrap">Start Building</span></Button>
                                    </div>
                                    <Button key={2} size="lg" variant="ghost" className="h-10.5 rounded-xl px-5" render={<Link href="#link" />} nativeButton={false}><span className="text-nowrap">Request a demo</span></Button>
                                </AnimatedGroup> */}
                            </div>
                        </div>
...
//                                 <Button variant="outline"  className={cn(isScrolled && 'lg:hidden')} render={<Link href="#" />} nativeButton={false}><span>Login</span></Button>
//                                 <Button  className={cn(isScrolled && 'lg:hidden')} render={<Link href="#" />} nativeButton={false}><span>Register</span></Button>
//                                 <Button  className={cn(isScrolled ? 'lg:inline-flex' : 'hidden')} render={<Link href="#" />} nativeButton={false}><span>Get Started</span></Button>
//                             </div>
//                         </div>
//                     </div>
//                 </div>
